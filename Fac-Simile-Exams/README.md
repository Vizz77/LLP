...
2) Lista ordinabile: definire `inversioni_lib` che conta quante volte un elemento è maggiore del successivo usando solo funzioni di libreria; e `inversioni_ric` ricorsiva.
